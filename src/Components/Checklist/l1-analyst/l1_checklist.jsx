...
export default function L1Checklist() {
	const [lcheck, setLcheck] = useState([])

	useEffect(() => {
		fetch('/data/l1check.json') // Assuming your JSON file is named "data.json" and located in the same directory
						...
						{lcheck.map((lcheck, index) => (
							<tr key={index}>
								...
								<td className="text-center ">
									<select class="select select-info w-40 max-h-10">
